defmodule Mastery.Boundary.QuizSession do
  ...
  def child_spec({quiz, email}) do
    # :id tuple uniquely identifies the process so supervisors can diff them
    # :start has everything OTP needs to invoke start_link func
    # - Module, name of func, args list
    # :restart defines policy for restarts
    %{
